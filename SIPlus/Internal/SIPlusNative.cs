...
namespace SIPlus
{
    internal static partial class SIPlusNative
    {
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_error_get", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial int siplus_error_get(out StringHandle message);

        [LibraryImport("siplus", EntryPoint = "siplus_error_set", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial int siplus_error_set(int err, string message);

        [LibraryImport("siplus", EntryPoint = "siplus_string_delete", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial void siplus_string_delete(IntPtr str);



        [LibraryImport("siplus", EntryPoint = "siplus_parser_new", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial ParserHandle siplus_parser_new();

        [LibraryImport("siplus", EntryPoint = "siplus_parser_context", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial int siplus_parser_context(out ContextHandle context, ParserHandle parser);

        [LibraryImport("siplus", EntryPoint = "siplus_parser_get_interpolation", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_parser_get_expression", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_parser_delete", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial void siplus_parser_delete(IntPtr parser);




        [LibraryImport("siplus", EntryPoint = "siplus_value_create", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_value_retrieve", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_value_unref", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial void siplus_value_unref(IntPtr parser);




        [LibraryImport("siplus", EntryPoint = "siplus_text_construct", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_text_unref", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial void siplus_text_unref(IntPtr parser);




        [LibraryImport("siplus", EntryPoint = "siplus_parse_opts_new", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial ParseOptsHandle siplus_parse_opts_new();

        [LibraryImport("siplus", EntryPoint = "siplus_parse_opts_add_global", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial int siplus_parse_opts_add_global(ParseOptsHandle opts, string name);

        [LibraryImport("siplus", EntryPoint = "siplus_parse_opts_delete", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial void siplus_parse_opts_delete(IntPtr opts);




        [LibraryImport("siplus", EntryPoint = "siplus_context_add_function", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial int siplus_context_add_function(ContextHandle context, string name, FunctionHandle handle);

        [LibraryImport("siplus", EntryPoint = "siplus_context_use_stl", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial int siplus_context_use_stl(ContextHandle context);

        [LibraryImport("siplus", EntryPoint = "siplus_context_builder", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_context_unref", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial void siplus_context_unref(IntPtr context);



        [LibraryImport("siplus", EntryPoint = "siplus_function_create", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_function_value", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_function_unref", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_icbuilder_with", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_icbuilder_default", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_icbuilder_build", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_icbuilder_delete", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial int siplus_icbuilder_delete(IntPtr builder);
       



        [LibraryImport("siplus", EntryPoint = "siplus_invocation_unref", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial void siplus_invocation_unref(IntPtr context);




        [LibraryImport("siplus", EntryPoint = "siplus_type_new", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_type_name", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial int siplus_type_name(out StringHandle ptr, TypeInfoHandle typeInfo);

        [LibraryImport("siplus", EntryPoint = "siplus_type_access", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_type_is_iterable", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_type_iterate", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_type_unref", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial void siplus_type_unref(IntPtr type);




        [LibraryImport("siplus", EntryPoint = "siplus_iterator_new", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_iterator_next", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial int siplus_iterator_next(IteratorHandle iterator);

        [LibraryImport("siplus", EntryPoint = "siplus_iterator_more", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_iterator_current", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial int siplus_iterator_current(out DataContainerHandle result, IteratorHandle iterator);

        [LibraryImport("siplus", EntryPoint = "siplus_iterator_delete", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial void siplus_iterator_delete(IntPtr iterator);




        [LibraryImport("siplus", EntryPoint = "siplus_data_make_int", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial DataContainerHandle siplus_data_make_int(long value);

        [LibraryImport("siplus", EntryPoint = "siplus_data_make_float", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial DataContainerHandle siplus_data_make_float(double value);

        [LibraryImport("siplus", EntryPoint = "siplus_data_make_string", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_data_is_int", StringMarshalling = StringMarshalling.Utf8)]
        [return:MarshalAs(UnmanagedType.I4)] internal static unsafe partial bool siplus_data_is_int(DataContainerHandle container);

        [LibraryImport("siplus", EntryPoint = "siplus_data_is_float", StringMarshalling = StringMarshalling.Utf8)]
        [return:MarshalAs(UnmanagedType.I4)] internal static unsafe partial bool siplus_data_is_float(DataContainerHandle container);

        [LibraryImport("siplus", EntryPoint = "siplus_data_is_string", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_data_is_bool", StringMarshalling = StringMarshalling.Utf8)]
        ...
        [LibraryImport("siplus", EntryPoint = "siplus_data_as_int", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial int siplus_data_as_int(out int val, DataContainerHandle container);

        [LibraryImport("siplus", EntryPoint = "siplus_data_as_float", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial int siplus_data_as_float(out double val, DataContainerHandle container);

        [LibraryImport("siplus", EntryPoint = "siplus_data_as_string", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial int siplus_data_as_string(out StringHandle val, DataContainerHandle container);

        [LibraryImport("siplus", EntryPoint = "siplus_data_as_bool", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial int siplus_data_as_bool(out int val, DataContainerHandle container);

        [LibraryImport("siplus", EntryPoint = "siplus_data_ptr", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial int siplus_data_ptr(out IntPtr ptr, DataContainerHandle container);

        [LibraryImport("siplus", EntryPoint = "siplus_data_type", StringMarshalling = StringMarshalling.Utf8)]
        internal static unsafe partial int siplus_data_type(out TypeInfoHandle ptr, DataContainerHandle container);

        [LibraryImport("siplus", EntryPoint = "siplus_data_delete", StringMarshalling = StringMarshalling.Utf8)]
